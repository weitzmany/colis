...
export class KeelInputComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "16.1.0", version: "21.1.5", type: KeelInputComponent, isStandalone: true, selector: "keel-input", inputs: { type: "type", placeholder: "placeholder", disabled: ["disabled", "disabled", booleanAttribute], invalid: ["invalid", "invalid", booleanAttribute] }, outputs: { valueChange: "valueChange" }, host: { properties: { "class.kh-input--invalid": "invalid" } }, providers: [
            {
