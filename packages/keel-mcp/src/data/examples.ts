...
export function getExamplesForComponent(component: string, variant?: string): ComponentExample[] {
  return COMPONENT_EXAMPLES.filter(
    (e) => e.component === component && (!variant || e.variant === variant),
  );
}
