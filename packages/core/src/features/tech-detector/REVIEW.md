...
**Files Modified**:
- `packages/core/src/features/tech-detector/standards/warning-detector.ts`
...
**Files Modified**:
- `packages/core/src/features/tech-detector/standards/warning-handler.ts`
...
**Files Modified**:
- `packages/core/src/features/tech-detector/standards/standards-loader.ts`
...
**Files Modified**:
- `packages/core/src/features/tech-detector/cli/commands/detect.ts`
- `packages/core/src/features/tech-detector/standards/warning-handler.ts`
...
1. `packages/core/src/features/tech-detector/standards/warning-detector.ts`
2. `packages/core/src/features/tech-detector/standards/warning-handler.ts`
3. `packages/core/src/features/tech-detector/standards/standards-loader.ts`
4. `packages/core/src/features/tech-detector/cli/commands/detect.ts`
