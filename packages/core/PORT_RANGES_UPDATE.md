...
- `packages/core/src/features/port-manager/core/allocator.ts` - Updated port ranges
- `packages/core/package.json` - Added cleanup script
- `packages/core/scripts/clean-port-registry.ts` - New cleanup utility
