...
Task management package for reading and managing tasks from taskmaster-ai (formerly: task-manager).
...
- **[Workflow Guide](../../docs/features/deck/WORKFLOW.md)** - Detailed workflow guide
