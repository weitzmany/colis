 ...
 */
export async function getLatestNpmVersion(packageName, tag = 'latest') {
 ...
 */
export async function getLatestAngularVersion() {
 ...
 */
export async function getAngularEcosystemVersions(angularVersion) {
...
export async function getLatestVersionCached(packageName) {
...
//# sourceMappingURL=npm-version-fetcher.js.map