 ...
 */
export function checkPhp(verbose = true): PhpCheckResult {
    const result: PhpCheckResult = {
        isAvailable: false,
        phpPath: null,
        phpVersion: null,
        inPath: false,
 ...
 */
export function printPhpInstallInstructions(): void {
    console.log(chalk.yellow('\n📦 How to install PHP:'));
    console.log('');
 ...
 */
export function printPathFixInstructions(_phpPath: string): void {
