...
**Files Created**:
- `packages/core/src/features/tech-detector/examples/github-actions-tech-check.yml`
...
- Created production-ready Dockerfile with:
  ...
  - Node.js 20 runtime
  - Global installation of @your-org/core
  - Health check for container orchestration
  - Configurable entrypoint and default commands
- Optimized for CI/CD and service deployments

**Files Created**:
- `packages/core/src/features/tech-detector/examples/Dockerfile`
...
# Install @your-org/core globally
RUN npm install -g @your-org/core
...
**Files Created**:
- `packages/core/src/features/tech-detector/examples/docker-compose.yml`
...
**Files Created**:
- `packages/core/src/features/tech-detector/examples/README.md`
...
│    ├─ @your-org/core (global installation)                    │
