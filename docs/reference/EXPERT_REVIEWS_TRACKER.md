...
| Carol Williams | Educational Content (Learning Materials) | 11 | 12 | 2026-01-05 | 0 | 1.1 | 3 | 0 |
...
| Total: | | 156 | 161 | 2026-01-05 | 13 | 1.03 | 76 | 2 |
| Benford: | | ❌ 0.0558 | ❌ 0.0473 | | ❌ 0.0524 | | ❌ 0.0287 | ❌ 0.0229 |
| Acceptance: | | ✓ 5.85% | ✓ 5.08% | | ✅ 60.06% | | ✓ 5.08% | ✅ 92.46% |
...
| `packages/core/rules/experts/graphql_expert.mdc` | 0 |
...
| `packages/core/rules/experts/security_expert.mdc` | 0 |
...
**Files Reviewed:**
  ...
  - `.cursor/commands/local/statistics.md`
  ...
  - `packages/core/commands/local/statistics.md`
...
**Files Reviewed:**
  ...
  - `docs/guides/PORT_MANAGEMENT_STRATEGY.md`
