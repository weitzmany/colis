...
|-------------|-----------|----------------|---------------|------------------|--------------|------------------------|-------------------|-----------------|
| Michael Brown | Mobile Optimization | 5 | 5 | 2026-01-05 | 0 | 1.0 | 1 | 0 |
| Patricia Martinez | Product Management (Conflict Resolution, Business Decisions) | 4 | 4 | 2026-01-05 | 0 | 1.0 | 4 | 0 |
| Dr. Robert Chen | Subject Matter (Physics, Math, CS, Academic Fields) | 4 | 4 | 2026-01-05 | 0 | 1.0 | 3 | 0 |
| James Martinez | Performance Optimization | 3 | 3 | 2026-01-05 | 0 | 1.0 | 2 | 0 |
| Dorothy Clark | Documentation (Code, API, User Documentation) | 3 | 3 | 2026-01-05 | 1 | 1.0 | 2 | 0 |
| Emma Rodriguez | Copywriting (App naming, section naming, website content) | 2 | 2 | 2026-01-05 | 0 | 1.0 | 2 | 0 |
| Rachel Kim | GraphQL API Design and Schema Development | 2 | 2 | 2026-01-05 | 0 | 1.0 | 1 | 0 |
| Arthur Davis | Architecture (System Design and Scalability) | 3 | 3 | 2026-01-05 | 0 | 1.0 | 1 | 0 |
| Steven Taylor | SEO (Search Engine Optimization) | 2 | 2 | 2026-01-05 | 0 | 1.0 | 2 | 0 |
...
| Nicole Chen | Observability (Monitoring, Logging, Tracing, Metrics) | 1 | 1 | 2026-01-05 | 0 | 1.0 | 1 | 0 |
...
| `.cursor/rules/experts/database_expert.mdc` | 0 |
...
- **Most Active Expert**: Michael Brown (5 reviews)
- **Most Reviewed File**: .cursor/rules/experts/documentation_expert.mdc (2 reviews)
