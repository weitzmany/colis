...
**Files Modified**:
- `packages/rig/src/shared/database/repository.ts`
...
**Files Modified**:
- `packages/rig/src/shared/database/factory.ts`
...
**Files Modified**:
- `packages/rig/src/shared/database/migrations.ts`
...
**Files Modified**:
- `packages/rig/src/shared/config/global-config.ts`
- `packages/rig/src/shared/config/project-config.ts`
- `packages/rig/src/shared/config/validator.ts`
...
**Files Modified**:
- `packages/rig/src/shared/database/index.ts`
- `packages/rig/src/shared/config/index.ts`
