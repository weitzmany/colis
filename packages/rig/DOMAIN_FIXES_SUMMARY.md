...
**Solution**:
Modified `packages/rig/src/features/port-manager/frameworks/angular.ts`:
...
**Solution**:
Modified `packages/rig/src/features/domain-manager/caddy-manager.ts`:
...
### 1. `packages/rig/src/features/port-manager/frameworks/angular.ts`
**Changes**:
...
### 2. `packages/rig/src/features/domain-manager/caddy-manager.ts`
**Changes**:
