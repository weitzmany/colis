...
**Created new file**: `packages/rig/src/features/port-manager/errors.ts`
...
1. `packages/rig/src/features/port-manager/errors.ts` - **NEW FILE**
2. `packages/rig/src/features/port-manager/port-manager.ts` - Updated error handling
3. `packages/rig/src/features/port-manager/core/allocator.ts` - Updated error handling
4. `packages/rig/src/features/port-manager/index.ts` - Added error exports
