...
- **Examples**:
  - `core/port-manager` → `packages/rig/src/features/port-manager/`
  - `core/commissioning` → `packages/rig/src/features/commissioning/`
...
Files modified:
  - packages/rig/src/features/port-manager/port-manager.ts
  - packages/rig/src/features/port-manager/core/validator.ts
...
Files modified:
  - packages/rig/src/features/port-manager/port-manager.ts
  - packages/rig/src/features/port-manager/database/port-repository.ts
Documentation updated: yes
```
